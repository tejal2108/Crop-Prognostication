...
crop_pred_dataset = pd.read_csv('crop-prod-dataset.csv')
...
print('accuracy : ', randomregressor.score(x_test,y_test)*100)#accuracy
...
print("rain :",rain,"temprature :", temp,"PH :",ph)    
predicted_crop_list={} 
for i in range(0,58):
    dic[lis[i]]=1.0
